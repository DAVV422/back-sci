...
| **[02. Roles, Permisos y Reglas de Negocio](file:///c:/Proyectos/SCI/back-sci/docs/sistema/02_roles_y_reglas_de_negocio.md)** | Jerarquía de roles de sistema (`suadmin`, `admin`, `manager`, `advanced`, `basic`), facultades tácticas del Comandante de Incidente, cargos SCI y matriz de permisos. |
