...
export class Form207Service {
    ...
    async create(createForm207Dto: CreateForm207Dto): Promise<Form207Entity> {
        ...
        const form207 = this.form207Repository.create({...createForm207, emergency: {id:emergency}});
    ...
    async update(id: string, updateForm207Dto: UpdateForm207Dto): Promise<Form207Entity> {
        const form207 = await this.findOne(id);
        const { emergency, ...updateForm207} = updateForm207Dto;
        this.form207Repository.merge(form207, {...updateForm207, emergency: {id:emergency}});
        return await this.form207Repository.save(form207);
    }
